...
// Back walls
      let backwall1 = new LongWall(0,-0.1,-14.69478);
        ...
        backwall1.obj.setAttribute("id","1")
      ...
      let backwall2 = new LongWall(0,0.9,-14.69478);
        ...
        backwall2.obj.setAttribute("id","2")
...
// -------------------------------------------------------------------
      ...
      this.obj.setAttribute("class","b2walls&floor")
